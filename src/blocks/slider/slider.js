let sliderUl = $('._slider-list'),
	...
	sliderDots = addElement('.slider__dots', "<div class='slider__dots-line'>", imgLenght),
	dots = $(checkChildren(sliderDots,'div')[0]).append("<div class='slider__dots-line slider__dots-active'>"),
	dotsActive = $('.slider__dots-active'),
